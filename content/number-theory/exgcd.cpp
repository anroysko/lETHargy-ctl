 ...
 * Author: Yuhao Yao
 * Date: 22-10-19
 * Desciption: Solve the integer equation $a x + b y = \gcd(a, b)$ for $a, b \ge 0$ and returns $x$ and $y$ such that $|x| \le b$ and  $|y| \le a$. \textbf{Note that} retured value $x$ and $y$ are not guaranteed to be positive!
 * Time: O(\log \max\{a, b\}).
